...
config = ProtDiffusionTrainingConfig(
    ...
    output_dir=os.path.join("output","ProtDiffusion-UniRef50-test_3"),  # the model name locally and on the HF Hub
...
Trainer = ProtDiffusionTrainer(transformer=transformer,
                               ...
                               eval_seq_len = [512, 512, 256, 256], # the sequence lengths to evaluate on
